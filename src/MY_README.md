...
![Создаем файл при помощи vim](./images/part_7.1.png)
Пишем dejaneom, жмем `ESC`, пишем `:wq`
2. Создаем файл при помощи nano `nano test_nano.txt`
![Создаем файл при помощи nano](./images/part_7.2.png)
...
![Открываем файл при помощи MCEDIT](./images/part_7.6.png)
...
* Запускаем `htop`
    - отсортированный по PID ![Запускаем htop](./images/part_9.2.png)
    - отсортированный по PERCENT_CPU ![Запускаем htop](./images/part_9.3.png)
    - отсортированный по PERCENT_MEM ![Запускаем htop](./images/part_9.4.png)
    - отсортированный по TIME ![Запускаем htop](./images/part_9.5.png)
    - отфильтрованный для процесса sshd ![Запускаем htop](./images/part_9.6.png)
    - с процессом syslog, найденным, используя поиск ![Запускаем htop](./images/part_9.7.png)
    - с добавленным выводом hostname, clock и uptime ![Запускаем htop](./images/part_9.8.png)
